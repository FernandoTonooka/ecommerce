...
<html lang="pt-br">
    ...
    <body>
        ...
        <form action="Controller" style="width: 530px;
        min-width: 530px; border: solid 3px; border-color: rgba(23,162,184,1);
        padding: 15px; border-radius: 10px;" method="post">
           
            <div class="form-group row">
                <div class="col-sm-12">
                    <h2 style="font-family: sans-serif; color: #0c5460">Entrar em sua Conta</h2>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-sm-2">
                    <label class="col-sm-2" for="txtCpf" style="font-family: sans-serif; font-size: 24px; color: teal">CPF</label>
                </div>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                <div class="col-sm-2">
                    <label class="col-sm-2" for="txtSenha" style="font-family: sans-serif; font-size: 24px; color: teal">Senha</label>
                </div>
                <div class="col-sm-10">
           ...
           <div class="form-group row">
                <div class="col-sm-2">
                 <input type="submit" id="operacao" name="operacao" value="ENTRAR" class="btn btn-xs btn btn-success btn-sm"/>
